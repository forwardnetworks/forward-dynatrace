...
- tenant approval for the checked read scopes, including `storage:spans:read` for the live instrumented dependency
  query; the app fails closed without that scope and has no seeded or replay fallback
