...
sanitized synchronization telemetry back to Dynatrace. It never reads Forward
credentials; it publishes only sanitized test or operating evidence to Dynatrace.
`;
