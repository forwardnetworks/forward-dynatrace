...
- [ ] `npm run ci`
- [ ] `git diff --check`
- [ ] Focused checks and any browser/live acceptance evidence are listed below.

## Workflow Impact

- [ ] Forward boundary unchanged: only Dynatrace app functions call Forward APIs; credentials remain backend-only and
...
- Open external gates or follow-up:
